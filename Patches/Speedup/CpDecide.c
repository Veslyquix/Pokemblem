...
// see
// https://github.com/FireEmblemUniverse/fireemblem8u/blob/b9ad9bcafd9d4ecb7fc13cc77a464e2a82ac8338/src/cp_decide.c#L71
...
// time between 8037744 HandlePostActionTraps and 8039F0C CpPerform_MoveCameraOntoUnit: 11.8m - 18.8m cycles or 36-56
// frames after cmb window disappears, 21 frames until greyed out then 51 frames until next unit starts moving
...
/*
            ...
            if (!gAiDecision.actionPerformed ||
                (gActiveUnit->xPos == gAiDecision.xMove && gActiveUnit->yPos == gAiDecision.yMove &&
